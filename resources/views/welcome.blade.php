                    ...
                    <form id="invoice-form" method="POST" action="{{ route('generate-invoice') }}">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <input type="text" name="invoice_no" style="border-bottom: 2px solid black" class="form-control">
                            </div>
                            <div class="col-md-3">
                                <p class="fw-bold">Date</p>
                                <input type="date" name="date" style="border-bottom: 2px solid black" class="form-control">
                            </div>
                            <div class="col-md-3">
                                <p class="fw-bold">Buyer's Name</p>
                                <input type="text" name="buyer_name" style="border-bottom: 2px solid black" class="form-control">
                            </div>
                            <div class="col-md-4">
                                <p class="fw-bold">Buyer's Phone</p>
                                <input type="text" name="buyer_phone" style="border-bottom: 2px solid black" class="form-control">
                            </div>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" id="sum-product-single-price" name="sum-product-single-price" class="form-control" readonly value="0">
                            </div>
                            <div class="col-md-2">
                                <p class="fw-bold">Complete Total</p>
                                <input type="text" id="sum-of-total-price" name="sum-of-total-price" class="form-control" readonly value="0">
                            </div>
                            <div class="col-md-2">
